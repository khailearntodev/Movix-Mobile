...
import { View, Text, ScrollView, TouchableOpacity, Image, ActivityIndicator, SafeAreaView, Platform } from 'react-native';
...
export default function BlogDetailScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-black" style={{ paddingTop: Platform.OS === 'android' ? 24 : 0 }}>
      ...
      {/* Bottom Actions Bar */}
      <View className="flex-row items-center justify-between px-4 py-3 bg-zinc-950 border-t border-zinc-900 pb-6">
        <View className="flex-row items-center flex-1">
          <TouchableOpacity 
            className="flex-row items-center py-2 mr-8"
            onPress={handleLike}
          >
            <ThumbsUp color={post.is_liked ? "#dc2626" : "#a1a1aa"} size={24} />
          ...
          <TouchableOpacity className="flex-row items-center py-2 mr-8">
            <MessageSquare color="#a1a1aa" size={24} />
        ...
        <View className="flex-row items-center">
          ...
          >
            <Bookmark color={post.is_bookmarked ? "#dc2626" : "#a1a1aa"} size={26} />
          </TouchableOpacity>
          
          <TouchableOpacity className="p-3">
            <Share2 color="#a1a1aa" size={26} />
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
